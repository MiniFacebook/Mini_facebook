...
public class MessageItemController implements Serializable {
    ...
    public void setSelected(MessageItem selected) {
    ...
    private MessageItemFacade getFacade() {
        return ejbFacade;
    }

    public MessageItem prepareCreate() {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("MessageItemCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("MessageItemUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("MessageItemDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<MessageItem> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class MessageItemControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof MessageItem) {
                MessageItem o = (MessageItem) object;
                return getStringKey(o.getId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), MessageItem.class.getName()});
                return null;
            }
        }
