...
public class AimeController implements Serializable {
    ...
    public void setSelected(Aime selected) {
    ...
    private AimeFacade getFacade() {
        return ejbFacade;
    }

    public Aime prepareCreate() {
        selected = new Aime();
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("AimeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("AimeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("AimeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Aime> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class AimeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Aime) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Aime.class.getName()});
                return null;
            }
        }
