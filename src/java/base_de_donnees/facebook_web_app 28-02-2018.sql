...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2018 at 11:46 PM
...
CREATE TABLE `invitation` (
  ...
  `IDGROUPE` varchar(255) DEFAULT NULL,
  `TYPE` varchar(255) DEFAULT NULL,
...
CREATE TABLE `publication` (
  ...
  `TEXTE` varchar(255) DEFAULT NULL,
  `EMETTEURPUBLICARTION_LOGIN` varchar(255) DEFAULT NULL,
  `GROUPE_ID` bigint(20) DEFAULT NULL,
  `RECEPTEURPUBLICARTION_LOGIN` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `publication`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `FK_PUBLICATION_EMETTEURPUBLICARTION_LOGIN` (`EMETTEURPUBLICARTION_LOGIN`),
  ADD KEY `FK_PUBLICATION_GROUPE_ID` (`GROUPE_ID`),
  ADD KEY `FK_PUBLICATION_RECEPTEURPUBLICARTION_LOGIN` (`RECEPTEURPUBLICARTION_LOGIN`);
...
--
ALTER TABLE `publication`
  ADD CONSTRAINT `FK_PUBLICATION_EMETTEURPUBLICARTION_LOGIN` FOREIGN KEY (`EMETTEURPUBLICARTION_LOGIN`) REFERENCES `user` (`LOGIN`),
